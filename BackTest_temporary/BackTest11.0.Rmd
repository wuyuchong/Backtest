---
title: "Stock Back Test 11.0 Former 2"
author: "Ethan"
output:
  html_document:
    df_print: paged
                    ...
                    stock_interval = 'daily', adj = TRUE, permit = FALSE)
{
  ...
  for(i in 4:nrow(dat))
  {
    if((dat$judge[i-2] == "down" & dat$judge[i-1] == "up") | (dat$judge[i-2] == "up" & dat$judge[i-1] == "down"))
    {
      kind = "fluc" # ------
      if(dat$judge[i] == "up" | dat$judge[i] == "up_down")
      {
        if(dire == "long")
        {
          dire = "flat"
      ...
      } else if(dat$judge[i] == "down" | dat$judge[i] == "down_up")
      {
        if(dire == "long")
        {
          next
