...
```{r}
BackTest = function(stock_code, stock_start, stock_end, proportion = 0.5, stock_interval = 'daily', stop_loss = FALSE, proportion_loss = 0, fix_loss = 0)
{
  dat = api(api_name = "pro_bar", ts_code = stock_code, start_date = stock_start, end_date = stock_end)
  cat(stock_code, stock_interval, "from", stock_start, "to", stock_end, "除权")
