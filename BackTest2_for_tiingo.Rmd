...
```{r}
BackTest = function(stock_code, stock_start, stock_end, proportion = 0.5, stock_interval = 'daily', adj = "qfq", stop_loss = FALSE, proportion_loss = 0, fix_loss = 0)
{
  dat <- getSymbols.tiingo(stock_code, from = stock_start, to = stock_end, auto.assign=FALSE, api.key = "23df16b0153d591648bac006196f7a9fa380908a", adjust = FALSE, periodicity = stock_interval)
...
stock_end = "2019-03-01"
list = BackTest(stock_code, stock_start, stock_end, proportion = 0.5, stop_loss = TRUE, fix_loss = 0.03)
```
...
stock_code = "000001"
stock_start = "2019-11-01"
stock_end = "2019-11-06"
is_supported_ticker("000001")
riingo_prices(stock_code, start_date = stock_start, end_date = stock_end, resample_frequency = "daily")
```

```{r}
getSymbols.tiingo(stock_code, from = stock_start, to = stock_end, auto.assign=FALSE, api.key = "23df16b0153d591648bac006196f7a9fa380908a", adjust = FALSE, periodicity = stock_interval)
```
